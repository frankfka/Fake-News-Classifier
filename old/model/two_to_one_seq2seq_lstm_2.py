...
from keras.layers import LSTM, Dense, Concatenate, TimeDistributed, Flatten, BatchNormalization, Dropout
...
"""
Two separate LSTM's that output sequences -> concatenated -> flatten -> dense layers for final prediction
"""
